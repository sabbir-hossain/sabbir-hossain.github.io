...
impl W {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 6
        position: self.generate_coordinates(max_x*(1.0-text.font_wide_h), max_y * (1.0-text.font_wide_v),  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 7
      ...
      Vertex { // 8
        position: self.generate_coordinates(max_x*text.font_wide_h*2.5, max_y * (1.0-text.font_wide_v*1.5),  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 9
        position: self.generate_coordinates(max_x*(1.0-text.font_wide_h*2.5), max_y * (1.0-text.font_wide_v*1.5),  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 10
      ...
      Vertex { // 11
        position: self.generate_coordinates(max_x*(1.0-text.font_wide_h*1.5), max_y * 0.5,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 12
        position: self.generate_coordinates(max_x / 2.0, max_y / 2.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 13
      ...
      Vertex { // 14
        position: self.generate_coordinates(max_x*text.font_wide_h*1.4, 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 15
        position: self.generate_coordinates(max_x*(1.0-text.font_wide_h*1.4), 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 16
    ...
    let indices = vec![
      ...
      self.generate_indices(4, 5, 1),
      self.generate_indices(4, 10, 5),
      self.generate_indices(4, 13, 10),
      self.generate_indices(13, 14, 10),
      self.generate_indices(14, 12, 10),
      self.generate_indices(10, 12, 8),
      self.generate_indices(8, 12, 9),
      self.generate_indices(9, 12, 11),
      self.generate_indices(12, 15, 11),
      self.generate_indices(15, 16, 11),
      self.generate_indices(11, 16, 7),
      self.generate_indices(6, 11, 7),
      self.generate_indices(2, 6, 7),
      self.generate_indices(2, 7, 3),
    ].concat();
