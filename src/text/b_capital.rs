...
impl B {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 3
        position: self.generate_coordinates(max_x * text.font_wide_h, max_y * 0.54,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 4
        position: self.generate_coordinates(max_x * text.font_wide_h, max_y * 0.42,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 5
        position: self.generate_coordinates(max_x * text.font_wide_h, max_y * text.font_wide_v,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 6
      ...
      Vertex { // 12
        position: self.generate_coordinates(max_x*0.76, max_y * 0.54,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 13
      ...
      Vertex { // 15
        position: self.generate_coordinates(max_x*0.76, max_y * 0.42,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 16
      ...
      Vertex { // 17
        position: self.generate_coordinates(max_x*0.85, max_y * 0.3,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 18
        position: self.generate_coordinates(max_x*0.85, max_y * 0.2,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 19
        position: self.generate_coordinates(max_x*0.8, max_y * 0.11,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 20
        position: self.generate_coordinates(max_x, max_y * 0.1,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 21
    ...
    let indices = vec![
      ...
      self.generate_indices(2,  6,  1),
      self.generate_indices(2,  8,  6),
      self.generate_indices(8,  7,  6),
      self.generate_indices(8,  9,  7),
      self.generate_indices(9,  10, 11),
      self.generate_indices(9,  11, 7),
      self.generate_indices(10, 12, 11),
      self.generate_indices(12, 13, 11),
      self.generate_indices(12, 15, 13),
      self.generate_indices(15, 14, 13),
      self.generate_indices(15, 16, 14),
      self.generate_indices(15, 17, 16),
      self.generate_indices(17, 18, 20),
      self.generate_indices(17, 20, 16),
      self.generate_indices(18, 19, 20),
      self.generate_indices(19, 21, 20),
      self.generate_indices(0,  19, 5),
      self.generate_indices(0,  21, 19),
      self.generate_indices(4,  15, 12),
      self.generate_indices(4,  12, 3),
    ].concat();
