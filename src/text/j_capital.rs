...
impl J {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 6
        position: self.generate_coordinates(max_x*0.87, 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 7
        position: self.generate_coordinates(max_x*(1.0 - text.font_wide_h), max_y*0.2,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 8
      ...
      Vertex { // 10
        position: self.generate_coordinates(0.0, max_y*text.font_wide_v*2.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 11
        position: self.generate_coordinates(max_x * text.font_wide_h, max_y*text.font_wide_v*2.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 12
        position: self.generate_coordinates(max_x *text.font_wide_h, max_y*text.font_wide_h,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 13
        position: self.generate_coordinates(max_x *0.25, max_y*text.font_wide_v,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 14
        position: self.generate_coordinates(max_x *0.75, max_y*text.font_wide_v,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
    ];
    ...
    let indices = vec![
      self.generate_indices(2, 3, 4),
      self.generate_indices(2, 4, 1),
      self.generate_indices(1, 4, 0),
      self.generate_indices(4, 7, 0),
      self.generate_indices(7, 5, 0),
      self.generate_indices(7, 6, 5),
      self.generate_indices(14, 6, 7),
      self.generate_indices(8, 6, 14),
      self.generate_indices(8, 14, 13),
      self.generate_indices(8, 13, 12),
