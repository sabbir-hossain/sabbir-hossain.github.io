...
impl Two {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 1
        position: self.generate_coordinates(0.0, max_y*0.72,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 2
        position: self.generate_coordinates(max_x*text.font_wide_h, max_y*0.72,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 3
      ...
      Vertex { // 9
        position: self.generate_coordinates(max_x*(1.0-text.font_wide_h), max_y*0.7,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 10
        position: self.generate_coordinates(max_x, max_y*0.67,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 11
        position: self.generate_coordinates(0.0, max_y*text.font_wide_v*1.2,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 12
      ...
      Vertex { // 15
        position: self.generate_coordinates(0.0, max_y*text.font_wide_v*0.5,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 16
        position: self.generate_coordinates(max_x*text.font_wide_h*0.5, 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
    ];
    ...
    let indices = vec![
      ...
      self.generate_indices(11, 15, 12),
      self.generate_indices(15, 16, 12),
      self.generate_indices(12, 16, 14),
