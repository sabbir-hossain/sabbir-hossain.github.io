...
impl R {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 8
        position: self.generate_coordinates(max_x*0.8, max_y * (1.0 - text.font_wide_v),  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 9
        position: self.generate_coordinates(max_x * 0.85, max_y * 0.8,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 10
        position: self.generate_coordinates(max_x * 0.85, max_y * 0.65,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 11
      ...
      Vertex { // 18
        position: self.generate_coordinates(max_x*0.85, 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 19
    ...
    let indices = vec![
      ...
      self.generate_indices(17, 18, 19),
      self.generate_indices(17, 19, 16),
