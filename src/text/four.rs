...
impl Four {
  ...
  pub fn get_coordinates(mut self, text: &Text) -> TextObject {
    ...
    let vertices = vec![
      ...
      Vertex { // 1
        position: self.generate_coordinates(max_x* (1.0-text.font_wide_h*2.0) , max_y,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 2
      ...
      Vertex { // 3
        position: self.generate_coordinates(max_x * (1.0-text.font_wide_h*2.0), 0.0,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 4
        position: self.generate_coordinates(max_x * (1.0-text.font_wide_h*2.5), max_y,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 5
      ...
      Vertex { // 6
        position: self.generate_coordinates(0.0, max_y * 0.38,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 7
      ...
      Vertex { // 8
        position: self.generate_coordinates(max_x, max_y * 0.38,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
      Vertex { // 9
        position: self.generate_coordinates(max_x * (1.0-text.font_wide_h*2.0), max_y*0.9,  0.0), 
        color: text.color, tex_coords: [0.0, 0.0], mode: 0,
      },
    ];
    ...
    let indices = vec![
      ...
      self.generate_indices(1, 2, 0),
      self.generate_indices(4, 5, 6),
      self.generate_indices(6, 1, 4),
      self.generate_indices(5, 6, 8),
      self.generate_indices(8, 7, 5),
      self.generate_indices(6, 9, 1),
    ].concat();
